...
<head>
	...
	<?
	Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/libs/animate/style.min.css');
	...
	Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/libs/remodal/remodal-default-theme.min.css');
	Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/libs/remodal/remodal.min.css');
	Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/libs/lidrekon/style.min.css');
	...
	// Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/css/index.5a4f293456be3da5b04b.css?'.time());
	if ($APPLICATION->GetCurPage() == '/new-year-2026/') {
		$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH . "/assets/css/ny2025.css");
		$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH . "/assets/libs/jquery/jqueryUI.min.css");
	}
	CJSCore::Init(["jquery"]);
				...
				<section data-scroll-section class="section__fs<? if (!$isMainPage) : ?> section<?endif;?> <? if ($isMainPage || $APPLICATION->GetCurPage(true) == '/404.php') echo 'fs_index';?> fs">
					...
					<? else : ?>
						<div class="container  <?=$APPLICATION->ShowProperty("padding_bottom")?>">
							...
							<div class="fs__page-title <? if ($APPLICATION->GetCurPage(false) == '/contacts/') : ?><? endif; ?> <?=$APPLICATION->ShowProperty("no_title")?><? if ($APPLICATION->GetCurPage() == "/about/navigation/") : ?> w100<?endif;?>" data-scroll>
								...
								<?endif;?>
								<? if ($APPLICATION->GetCurPage() != "/about/halls/new-concert-space/") : ?>
									<? if (($APPLICATION->GetDirProperty('PAGE_SUBTITLE') || $APPLICATION->GetPageProperty('PAGE_SUBTITLE')) && $APPLICATION->GetCurPage() != "/about/navigation/") : ?>
									...
									<? endif; ?>
									<? if ($APPLICATION->GetCurPage() == "/about/navigation/") : ?>
