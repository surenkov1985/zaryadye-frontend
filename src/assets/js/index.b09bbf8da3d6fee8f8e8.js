...
;// ./assets/js/ajax_handler.js
function ajax_handler_typeof(o) { "@babel/helpers - typeof"; return ajax_handler_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ajax_handler_typeof(o); }
function ajax_handler_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function ajax_handler_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, ajax_handler_toPropertyKey(o.key), o); } }
function ajax_handler_createClass(e, r, t) { return r && ajax_handler_defineProperties(e.prototype, r), t && ajax_handler_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function ajax_handler_toPropertyKey(t) { var i = ajax_handler_toPrimitive(t, "string"); return "symbol" == ajax_handler_typeof(i) ? i : i + ""; }
function ajax_handler_toPrimitive(t, r) { if ("object" != ajax_handler_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != ajax_handler_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
document.addEventListener("DOMContentLoaded", function () {
  var AjaxLoadHandler = /*#__PURE__*/function () {
    function AjaxLoadHandler() {
      ajax_handler_classCallCheck(this, AjaxLoadHandler);
      this.init();
    }
    return ajax_handler_createClass(AjaxLoadHandler, [{
      key: "ajaxReplaceContent",
      value: function ajaxReplaceContent(params) {
        console.log(88);
        params = params || {};
        var dataAttribute = params.dataAttribute;
        var $html = params.html;
        var res = params.res || {};
        var isParseSelector = params.isParseSelector === true;
        var isAppend;
        jquery_default()("[data-".concat(dataAttribute, "]")).each(function (key, item) {
          var $item = jquery_default()(item);
          var keyValue = $item.data(dataAttribute);
          var newHtml = false;
          isAppend = params.isAppend === true && $item.is('[data-ajax-append="true"]');
          if (isParseSelector) {
            var $replaceEl = $html.find("[data-".concat(dataAttribute, "='").concat(keyValue, "']"));
            if ($replaceEl.length) {
          ...
          if (newHtml) {
            if (isAppend) {
              $item.append(jquery_default()(newHtml));
            } else {
      ...
      value: function loadContent(params) {
        ...
        var $loadTo = jquery_default()(params.selector);
        if (!$loadTo.length) {
          return;
        }
        ...
        jquery_default()(window).trigger("preloader:show", $loadTo);
        jquery_default().ajax({
          url: params.url,
          data: params.query,
          ...
          success: function success(res) {
            jquery_default()(window).trigger("preloader:hide", $loadTo);
            var html = params.isJson ? res.html : res;
            var $html;
            if (params.isParseSelector) {
              $html = jquery_default()("<div>").append(html);
            ...
            if (params.isPrepend) {
              ...
              $loadTo.html(html);
              var faq = jquery_default()(res).find(".faq");
              if (faq.length) {
                // cafeSliders();
                // window.scroll.start();
              }
              if (params.url === "/event/perenosy-i-otmeny/" || params.url === "/events/reschedules-and-cancellations/") {
                jquery_default()("#cancelled").hide();
              } else {
                jquery_default()("#cancelled").show();
              }
            }
      ...
      value: function initHandlers() {
        var self = this;
        jquery_default()(document).on("reset", "[data-ajax-form-to]", function (event) {
        ...
        jquery_default()(document).on("submit", "[data-ajax-form-to]", function (event) {
        ...
        jquery_default()(document).on("click", "[data-ajax-link-to]", function (event) {
          event.preventDefault();
          var $this = jquery_default()(this);
          console.log(33);
        ...
        jquery_default()(document).on("click", "[data-submit-form-on-click]", function (event) {
          event.preventDefault();
          var $this = jquery_default()(this);
          jquery_default()($this.data("submit-form-on-click")).trigger("submit", {
            query: $this.data("query")
          });
        });
        jquery_default()(window).on("init.ajax", function () {
          jquery_default()(window).trigger("scroll");
        });
      }
    }, {
      key: "init",
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [999], function() { return __webpack_require__(1428); })
